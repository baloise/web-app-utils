...
describe('date', () => {
  ...
  describe('isInRange', () => {
    test('should verify if the date is in range', () => {
      ...
      expect(isInRange(toDate('2020-01-01'), toDate('2020-01-02'), toDate('2020-02-01'))).toBe(false)
      expect(isInRange(toDate('2020-01-02'), toDate('2020-01-02'), toDate('2020-02-01'))).toBe(true)
      expect(isInRange(toDate('2020-02-01'), toDate('2020-01-02'), toDate('2020-02-01'))).toBe(true)
      expect(isInRange(toDate('2020-01-01'), toDate('2020-02-02'), toDate('2020-02-01'))).toBe(false)
    })
  })
