...
export const LanguagesOfGermany: LanguageModel = new LanguageModel([GERMAN, ENGLISH], GERMAN)

export const LanguagesOfBelgium: LanguageModel = new LanguageModel([DUTCH, FRENCH, GERMAN, ENGLISH], DUTCH)
